...
const useClaim = (refresh = "never") => {
    ...
    return {
        ...
        claimAmount: (0, lodash_1.first)((_d = results[3]) === null || _d === void 0 ? void 0 : _d.value) || ethers_1.BigNumber.from("0"),
        claimTime: startRef,
        claimCall
    };
};
...
const useWhitelistSync = () => {
    ...
    (0, react_1.useEffect)(() => {
        const whitelistSync = async () => {
            ...
            if (!isSynced && (fuseResult === null || fuseResult === void 0 ? void 0 : fuseResult.value[0]) && (otherResult === null || otherResult === void 0 ? void 0 : otherResult.value[0]) === false) {
                const { backend } = constants_1.Envs[baseEnv];
    ...
    return {
        fuseWhitelisted: fuseResult === null || fuseResult === void 0 ? void 0 : fuseResult.value,
        currentWhitelisted: otherResult === null || otherResult === void 0 ? void 0 : otherResult.value,
        syncStatus
    };
};
